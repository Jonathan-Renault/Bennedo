 ...
 */
final class Version20200114090315 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE consumer RENAME COLUMN ip_address TO check_info');
        ...
        $this->addSql('ALTER TABLE consumer_has_bin ALTER id_report TYPE UUID');
        $this->addSql('ALTER TABLE consumer_has_bin ALTER id_report DROP DEFAULT');
        $this->addSql('ALTER TABLE consumer_has_bin ALTER id_consumer TYPE UUID');
        $this->addSql('ALTER TABLE consumer_has_bin ALTER id_consumer DROP DEFAULT');
        $this->addSql('ALTER TABLE consumer_has_bin ALTER id_bin TYPE UUID');
        $this->addSql('ALTER TABLE consumer_has_bin ALTER id_bin DROP DEFAULT');
        ...
        $this->addSql('ALTER TABLE report ALTER id_bin TYPE UUID');
        $this->addSql('ALTER TABLE report ALTER id_bin DROP DEFAULT');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('COMMENT ON COLUMN report.id_bin IS NULL');
        ...
        $this->addSql('ALTER TABLE consumer ADD device VARCHAR(100) NOT NULL');
        $this->addSql('ALTER TABLE consumer ADD navigator VARCHAR(100) NOT NULL');
        $this->addSql('ALTER TABLE consumer ALTER id TYPE UUID');
        ...
        $this->addSql('ALTER TABLE consumer RENAME COLUMN check_info TO ip_address');
        ...
        $this->addSql('COMMENT ON COLUMN consumer_has_bin.id_bin IS NULL');
        $this->addSql('COMMENT ON COLUMN consumer_has_bin.id_consumer IS NULL');
        $this->addSql('COMMENT ON COLUMN consumer_has_bin.id_report IS NULL');
