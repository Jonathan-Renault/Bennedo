 ...
 */
final class Version20200121104646 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bin ALTER name SET NOT NULL');
        ...
        $this->addSql('ALTER TABLE consumer ALTER check_info SET NOT NULL');
        ...
        $this->addSql('ALTER TABLE consumer_has_bin ADD hash_consumer VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE consumer ALTER check_info DROP NOT NULL');
        ...
        $this->addSql('ALTER TABLE bin ALTER name DROP NOT NULL');
        ...
        $this->addSql('ALTER TABLE consumer_has_bin DROP hash_consumer');
        $this->addSql('ALTER TABLE consumer_has_bin ALTER id TYPE UUID');
