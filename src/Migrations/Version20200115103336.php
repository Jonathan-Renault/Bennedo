 ...
 */
final class Version20200115103336 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE admin (id UUID NOT NULL, login VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, token VARCHAR(255) DEFAULT NULL, role VARCHAR(100) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE consumer (id UUID NOT NULL, coords geography(POINT, 4326) DEFAULT NULL, id_closest_bin UUID NOT NULL, check_info VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE consumer_has_bin (id UUID NOT NULL, action VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, id_bin UUID NOT NULL, id_consumer UUID NOT NULL, id_report UUID NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE report (id UUID NOT NULL, id_bin UUID NOT NULL, type VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, time_resolved TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
